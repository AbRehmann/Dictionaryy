...
function CardSlider() {
  ...
  const wordsData = [
    ...
    { id: 18, word: "دھوپ", meaning: "Sunshine" },
    { id: 19, word: "چائے", meaning: "Tea" },
    { id: 20, word: "کھانا", meaning: "Food" },
  ];

  return (
    <div>
      <div>
        <h1 className="font-semibold text-3xl">Trending Urdu Words</h1>
      </div>
      ...
      <Swiper
        ...
        className="swiper-container" // Add this class to target the Swiper wrapper
      >
        {wordsData.map((word) => (
          <SwiperSlide key={word.id}>
            <div className="text-center max-w-sm mx-auto bg-blue-900 rounded-md overflow-hidden shadow-md m-4 sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
              <div className="p-6">
                ...
                <button className="mt-4 bg-white text-black px-5 py-3 rounded-md hover:bg-blue-100">
                  Learn More
                </button>
              </div>
            </div>
      ...
      <style jsx>{`
        ...
        .swiper-container {
          padding-bottom: 18px; // Add padding-bottom to the Swiper wrapper
        }
      `}</style>
    </div>
  );
...
//     fetch("") // Replace with your dummy API endpoint
