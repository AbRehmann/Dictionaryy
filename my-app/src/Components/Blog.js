        ...
        <a href="kd" className="block">
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col justify-between">
              ...
              <a
                href="edc"
                className="inline-block mb-6 mt-12  text-center px-4 py-2 text-sm font-medium text-white bg-blue-800 border border-blue-600 rounded-lg hover:bg-white hover:text-blue-400"
              >
                See All
              </a>
            </div>
